...
def get_config():
  ...
  # ================================================= #
  config.intrinsic_reward = ml_collections.ConfigDict()
  config.intrinsic_reward.enabled = False
  config.intrinsic_reward.intrinsic_weight = 0.1
  config.intrinsic_reward.extrinsic_weight = 1.0
  config.intrinsic_reward.max_states = 1000  # Reduced from 10000
  config.intrinsic_reward.novelty_threshold = 0.1
  config.intrinsic_reward.method = "kmeans"  # "kmeans" | "hash" | "distance" | "re3"
  config.intrinsic_reward.n_clusters = 50  # Reduced from 100
  config.intrinsic_reward.memory_decay = 0.99

  config.intrinsic_reward.re3 = ml_collections.ConfigDict()
  config.intrinsic_reward.re3.k = 3
  config.intrinsic_reward.re3.embed_dim = 512
  config.intrinsic_reward.re3.beta0 = 0.1      # initial scale (use this instead of intrinsic_weight)
  config.intrinsic_reward.re3.beta_decay = 0.0 # e.g., 1e-6 per env step; 0.0 = constant
  config.intrinsic_reward.re3.memory_subsample = 4096  # candidate set size for kNN
  config.intrinsic_reward.re3.use_images = True

  # ================================================= #
  # Training parameters.
  # ================================================= #
  config.num_train_steps = 75_000
  config.replay_buffer_capacity = 1_000_000 # 1_000_000
  ...
  config.sac.batch_size = 4096 # 1024

"""
Modified from: https://github.com/haosulab/ManiSkill/blob/8c8d33916e07984057cf3d30e5cb9d5c26377b03/mani_skill/examples/motionplanning/panda/run.py
"""
...
python inest_irl/maniskill3/panda_motionplanner.py
    ...
    --record-dir ../.maniskill/less-rand_demos
    --num-procs 10
    --env-randomization minimal
"""
...
# import it to register the custom environment
...
MP_SOLUTIONS = {
    ...
    "StackPyramid-v1custom": solveStackPyramid,
}


def parse_args(args=None):
    parser = argparse.ArgumentParser()
    parser.add_argument("-e", "--env-id", type=str, default="StackPyramid-v1custom", help=f"Environment to run motion planning solver on. Available options are {list(MP_SOLUTIONS.keys())}")
    parser.add_argument("-o", "--obs-mode", type=str, default="state", help="Observation mode to use. Usually this is kept as 'none' as observations are not necesary to be stored, they can be replayed later via the mani_skill.trajectory.replay_trajectory script.")
    ...
    parser.add_argument("--env-randomization", type=str, default="default", help="Type of environment randomization to use. Can be 'none', 'minimal', 'default', or 'same-seed'.")

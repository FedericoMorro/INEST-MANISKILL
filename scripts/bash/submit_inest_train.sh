...
echo " Reward Scaling: $REWARD_SCALING"
echo " Environment Randomization: $ENV_RANDOMIZATION"
...
CMD="python /home/fmorro/INEST-MANISKILL/scripts/sb3_sac.py \
    ...
    --config.env_randomization=$ENV_RANDOMIZATION \
